---
{"dg-publish":true,"permalink":"/problems/14-longest-common-prefix/","tags":["Leetcode"]}
---
...
| -------- | ----- |
| O(NlogN) | O(N)  |
Assuming that the sorting algorithm used is [[Quick Sort\|Quick Sort]] like in the case of `List<T>.Sort()`